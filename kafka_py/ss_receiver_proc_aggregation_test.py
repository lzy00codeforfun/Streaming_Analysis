...
# - create SparkContext and StreamingContext
   ...
   #     return text_map["text"]
    ...
    def pre_processing_text(text):
        ...
        print("preprocessing text", final_words, '---------')
        return final_words
    ...
    # preprocess text
    words = words.withColumn('preprocessed_text', pre_processing_text('value'))
    # vectorize text
...
# CAST(key AS STRING)
    words_vector = words.filter(words.preprocessed_text != "")
